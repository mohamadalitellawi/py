...
from buisness import Investment
...
class FutureValueFrame(ttk.Frame):
    def __init__(self, parent) -> None:
        ...
        self.message = ""   #Hold Error Messages
    ...
    def initComponents(self):
        self.pack()
        ttk.Label(self,text="Monthly Investments:").grid(column=0, row = 0,sticky=tk.E)
    ...
    def makeButtons(self):
        ...
        ttk.Button(buttonFrame, text="Exit",command=self.parent.destroy).grid(column=1, row=0, padx=5) 
    ...
    def calculate(self):
        ...
        self.investment.monthlyInvestment = self.get_float( self.monthlyInvestment.get(), "Monthly investment") 
        self.investment.yearlyInterestRate = self.get_float( self.yearlyInterestRate.get(), "Yearly interest rate") 
        self.investment.years = self.get_int( self.years.get(), "Years")
